...
@section('content')
    <div class="row">
        ...
        <form action="{{route('slide.store')}}" enctype="multipart/form-data" method="post" role="form">
        @csrf
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" placeholder="eg: Giày Nike" name="title">
        ...
        <div class="form-group">
            ...
            <div class="form-group  ">
                <select class="select2" name="type" data-minimum-results-for-search="Infinity">
                    ...
                    <option value="1">Slide category hình lớn trên trang chủ</option>
                    <option value="2">Slide category hai hình nhỏ trang chủ</option>
                    <option value="3">Slide category hình lớn dưới trang chủ</option>
                    <option value="4">Slide Black Friday</option>
                    <option value="5">Slide countdown trang chủ</option>
                </select>
                <br><br>
            </div>
        </div>
