...
@section('content')
    ...
    {{--<a href="{{route('post.create')}}" class="btn btn-dark">Thêm bài viết mới</a>--}}
    {{--</header>--}}


    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Quản lý đơn hàng chưa xử lý</h4>
                    ...
                    @if(count($listOrders))
                        @foreach($listOrders as $item)
                            <tr>
                                ...
                                <td>
                                    {{--@if($item->status == 0)--}}
                                        {{--<a data-id="{{$item->id}}" class="update" href="javascript:void(0)"--}}
                                           {{--data-toggle="tooltip" title="Đã hoàn thành!"><i--}}
                                                    {{--class="zmdi zmdi-refresh zmdi-hc-fw"></i>--}}
                                        {{--</a>--}}
                                    {{--@endif--}}
                                    {{--<a href="{{route('order.edit',$item->id)}}" data-toggle="tooltip"--}}
                                       {{--title="Chi tiết đơn hàng"> <i--}}
                                                {{--class="zmdi zmdi-eye zmdi-hc-fw"> </i>--}}
                                    {{--</a>--}}
